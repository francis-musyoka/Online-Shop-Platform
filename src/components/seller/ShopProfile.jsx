...
import { validate, validateAddressForm } from '../../utilis/validateForms';
...
const ShopProfile = () => {
    ...
    return (
        <div>
            <form onSubmit={handleSubmit} className='mx-auto border rounded-lg shadow-sm bg-orange-100 mb-20 mt-4'>
                ...
                <div className=" text-right px-6 mb-10">
                    <button
                        type="submit"
                        className="bg-yellow-900 text-white text-xl py-4 px-6 rounded-lg hover:bg-amber-400"
                    >
                    Save
                    </button>
                </div>
